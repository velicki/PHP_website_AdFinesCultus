                    ...
                    <div class="adonama">
                        <form action="kontakt.php" name="myform" id="myform" method="POST" enctype="multipart/form-data">
                            <div class="divimgonama">
                                <div class="dugme">
                                    <a href="vestiNova.php">Dodaj Novu Vest</a>
                                </div>
                            </div>
                        ...
                        while( $row = mysqli_fetch_array($set))
                        {
                                echo""                      
                                    ."<div class='divimgonama'>"
                                        .""
                                        ."<div><img  src='../Images/vesti/$row[imeslike]?id=$row[id]'  class='novostislikaadmin'  />"
                                        ...
                                        . "<br><div class='dugme'>"
                                            ."<a href='vestiDorada.php?more=$row[id]'>Izmeni Ovu Vest</a>"
                                        ."</div><br><br>"
                                        . "<div class='dugme'>"
                                            ."<a href='vesti.php?delete=$row[id]'>Izbriši Ovu Vest</a>"
                                        ."</div>"
                                ...
                                if (isset($_GET['delete']))
                                {
                                    ...
                                    $id = $_GET['delete'];
                                    $file = mysqli_query($con, "SELECT * FROM vesti WHERE id='$id'");
                                    while ($row1 = mysqli_fetch_array($file))
                                    { 


                                        $location = '../Images/vesti/';
                                        $location1 = $row1[4];
