        ...
        <div id="sajt">
            ...
            <div id="vesti">
                <div class="novosti">
                    ...
                    &nbsp &nbsp &nbsp Dodavanje Nove Vesti
                </div>
                <div id="svesti">
                    <div class="adonama">
                            <form action="vestiNova.php" name="myform" id="myform" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="divimgonama">
                                <input type="submit" name="upload" value="Dodaj Vest" onClick="javascript:submit_form();">
                                </div>
                                        ...
                                        else 
                                        {
                                            ...
                                            $location1 = '../Images/vesti/';
                                                ...
                                                {    
                                                    ...
                                                    $newsfull = $prepravka;
                                                    if($insert = mysqli_query ($con, "INSERT INTO vesti  (naslov, tekst, kratakt, imeslike, autor )
                                                                                          VALUES ('$_POST[namenews]','$newsfull','$_POST[shortnews]','$image_name','$_POST[autor]')"))
                                                    {

                                                        $lastid = mysqli_insert_id();
                                                        echo "<img src=../Images/vesti/$image_name >";
